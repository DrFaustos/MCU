...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "sip": {
        ...
        "codecs": {
            ...
            # максимальной совместимости с парком ВКС Polycom/Sony:
            # обязательные узкополосные G.711 (PCMU/PCMA) и G.722 — на случай
            # H.323-шлюзов; G.722.1/G.723.1/G.728 встречаются у старых
            # терминалов; opus — для современных SIP-клиентов.
            "audio": [
                "PCMU/8000/1",
                "PCMA/8000/1",
                "G722/16000/1",
            ...
            # Порядок = приоритет. H.264 — основной (Polycom/Sony 720p/1080p);
            # H.263/H.263+/H.261 — для старого парка; VP8/VP9/H.265 — новее.
            "video": [
                "H264/90000",
                "H263/90000",
                "H263-1998/90000",
